...
export default function EditBlogPage() {
  ...
  const fetchBlog = async () => {
    try {
      ...
      const response = await fetch(`/api/blogs/${params.slug}?admin=true`, {
        headers: {
      ...
      setError('Network error while retrieving article');
    ...
    return (
      <div className="min-h-screen bg-[#0B0F19] flex items-center justify-center">
        <div className="text-center">
          ...
          <p className="text-xs font-bold uppercase tracking-widest text-slate-400">Loading Article Dossier...</p>
        </div>
      </div>
    );
  }
      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 pt-8">
        {error && (
          <div className="bg-rose-50 border border-rose-200 text-rose-800 p-4 rounded-2xl mb-6 flex items-start gap-3">
            ...
            <div>
              <p className="text-xs font-bold uppercase tracking-wider">Update Error</p>
        ...
        <form onSubmit={handleSubmit} className="space-y-6">
          ...
          <div className="bg-white rounded-3xl border border-slate-200/80 p-6 sm:p-8 shadow-sm space-y-6">
            <div>
              ...
              <input
                ...
                required
                className="w-full px-4 py-3.5 text-lg font-bold text-slate-900 border border-slate-300 rounded-2xl focus:ring-2 focus:ring-[#D7242A] focus:border-[#D7242A] transition-all"
            ...
            <div>
              ...
              <textarea
                ...
                rows={3}
                maxLength={300}
                className="w-full px-4 py-3 text-sm text-slate-800 border border-slate-300 rounded-2xl focus:ring-2 focus:ring-[#D7242A] focus:border-[#D7242A] transition-all"
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 pt-2">
              <div>
                ...
                <input
                  ...
                  placeholder="Real Estate, Investment, Luxury"
                />
              </div>
              ...
              <div>
                ...
                <input
                  ...
                  onChange={handleInputChange}
                  className="w-full px-4 py-3 text-sm border border-slate-300 rounded-xl focus:ring-2 focus:ring-[#D7242A] focus:border-[#D7242A]"
                  placeholder="bangalore, luxury-flats, investment"
                />
              </div>
            </div>
          </div>
          ...
          <div className="bg-white rounded-3xl border border-slate-200/80 p-6 sm:p-8 shadow-sm space-y-6">
            ...
            <div className="bg-slate-50 p-4 rounded-2xl border border-slate-200/80 font-sans">
              ...
              <p className="text-xs text-emerald-700 font-medium">https://a4realty.com › blog › {params.slug}</p>
              <h4 className="text-base font-bold text-blue-800 hover:underline cursor-pointer line-clamp-1">
                {formData.seo.metaTitle || formData.title} | A4 Realty
              </h4>
              <p className="text-xs text-slate-600 line-clamp-2 mt-0.5">
                {formData.seo.metaDescription || formData.excerpt || 'Article summary snippet for Google organic results.'}
              </p>
            </div>
            ...
            <div className="space-y-4">
              ...
              <div>
                ...
                <input
                  ...
                  onChange={handleInputChange}
                  className="w-full px-4 py-2.5 text-sm border border-slate-300 rounded-xl focus:ring-2 focus:ring-[#D7242A] focus:border-[#D7242A]"
                  placeholder="luxury properties, investment advice, bangalore real estate"
                />
              </div>
            </div>
          </div>
